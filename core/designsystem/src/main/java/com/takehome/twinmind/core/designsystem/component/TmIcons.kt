...
object TmIcons {
    ...
    val Waveform: ImageVector = Icons.Default.GraphicEq
    val Mail: ImageVector = Icons.Default.Mail
    val Link: ImageVector = Icons.Default.Link
    val More: ImageVector = Icons.Default.MoreVert
    val Person: ImageVector = Icons.Default.PersonOutline
    val Upload: ImageVector = Icons.Default.UploadFile
    val Desktop: ImageVector = Icons.Default.DesktopWindows
    val Language: ImageVector = Icons.Default.Language
    val Personalize: ImageVector = Icons.Default.Tune
